...
internal static class Program
{
    ...
    private static void Main()
    {
        ...
        do
        {
            ...
            Console.WriteLine(@"               /_/    \_\__,_| \_/ \___|_| |_|\__|\____/|_|  \_____\___/ \__,_|\___|____|\___/ |_|\___/  ");
            Console.WriteLine("");
            ...
            do
            {
                ...
                if (!string.IsNullOrEmpty(toSolveInfo))
                {
                    ...
                    {
                        // Load requested day
                        Type? solverToLoad = Type.GetType($"AdventOfCode2018.Solver.Day{day:00}");
